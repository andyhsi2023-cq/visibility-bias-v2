#!/usr/bin/env python3
"""
phase-K/passage_sample.py — stratified sentence sampler for VAI passage-level validation.
...
`03-analysis/phase-K-passage-validation-plan.md`.
...
CONFIG = {
    ...
    "visible_lexicon": str(PROJ / "02-data/processed/lexicon_visible_concrete.txt"),
    "functional_lexicon": str(PROJ / "02-data/processed/lexicon_functional_concrete.txt"),
    "out_dir": str(PROJ / "03-analysis/phase-K"),
    "seed": 20260719,                       # pass via OSF amendment; do NOT change post-hoc
