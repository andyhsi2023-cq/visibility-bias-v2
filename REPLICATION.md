...
- Public secondary sources: China Urban Construction Statistical Yearbook (Ministry of Construction / MOHURD, 2005–2015); CFPS (PKU ISSS); CCDI inspection rounds.

## Archive status (R2, 2026-06-19)
- **Zenodo**: published, **Open access** (CC-BY-4.0). Concept DOI [10.5281/zenodo.19569978](https://doi.org/10.5281/zenodo.19569978) always resolves to the latest version.
...
- The concrete visible/functional lexicon is the authors' own construction (validated by the passage coding, §3.2.0), mirroring the cosmetic-vs-functional split of the MOHURD construction-investment categories (§3.3).
